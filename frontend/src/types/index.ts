...
export interface Source { filename: string; page?: number | null; display_name?: string | null; category?: string | null; issuing_unit?: string | null; document_year?: number | null }
...
export interface SessionInfo { session_id: string; title?: string }
